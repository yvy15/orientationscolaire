...
class _GererApprenantState extends State<GererApprenant> {
  ...
  /* Future<void> _chargerMatieres() async {
    ...
    setState(() {
      _matieres = matieres.cast<Map<String, dynamic>>();
  ...
  Future<void> _ajouterApprenant() async {
    ...
    print(
        'la filiere est : $_filiereSelectionnee,$matricule, $_classeSelectionnee,  $_dateInscription');
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            child: const Text('Ajouter fg Apprenant'),
          ),
